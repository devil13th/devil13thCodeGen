...
public class MysqlJdbcUtilImpl extends JdbcUtilImpl {
	...
	public MysqlJdbcUtilImpl(String uname,String upwd,String url){
		super(uname, upwd, url);
	...
	public List<CodeGenColumnConfig> loadColumnCfg(String dbTableName) throws Exception {
		...
		try{
			...
			String sql = "select "
					...
					+ " from information_schema.COLUMNS where TABLE_NAME like ? order by ORDINAL_POSITION asc";
